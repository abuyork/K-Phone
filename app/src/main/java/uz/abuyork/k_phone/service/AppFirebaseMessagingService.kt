package uz.abuyork.k_phone.service
...
import uz.abuyork.k_phone.BuildConfig
    ...
    fun showMessage(title: String, body: String, id: Long = System.currentTimeMillis()){
        ...
        val builder =
            NotificationCompat.Builder(this, channelId)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(applicationContext.resources, R.drawable.minion))
